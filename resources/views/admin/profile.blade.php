  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="card shadow-sm">
          <div class="card-body">
            <a class="btn btn-sm btn-primary" href="{{ route('admin.edit') }}" role="button">Edit</a>
            <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.password') }}" >Ubah Password</a>
          </div>
          <div class="card-footer bg-light">
            <a class="btn btn-sm btn-secondary" href="{{ route('admin') }}" >Kembali</a>
          </div>
        </div>
