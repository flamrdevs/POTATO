      ...
      <div class="card-body">
        ...
        <div class="form-group">
          <div class="d-flex justify-content-between">
            <div>
              <a class="btn btn-secondary" href="{{ route('farmer') }}" >Kembali</a>
            </div>
            <div>
              <a class="btn btn-outline-primary" href="{{ route('farmer.password') }}" >Ubah Password</a>
              <a class="btn btn-primary" href="{{ route('farmer.edit') }}" role="button">Edit</a>
            </div>
          </div>
        </div>
