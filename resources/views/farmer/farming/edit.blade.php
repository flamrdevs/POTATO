      ...
      <div class="col-lg-9">
        ...
        <div class="card shadow-sm">
          <div class="card-body">
            ...
            <form id="create-form" action="{{ route('farmer.farming.update', ['id' => $farming->id]) }}" method="POST">
              {{ csrf_field() }}
              {{ method_field('PUT') }}
      ...
      <div class="col-lg-3">
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-footer bg-light">
            <a class="btn btn-sm btn-secondary" href="{{ route('farmer.farming.show', ['id' => $farming->id]) }}" >Batal</a>
          </div>
        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <form id="status-form" action="{{ route('farmer.farming.update', ['id' => $farming->id]) }}" method="POST" style="display: none;">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
